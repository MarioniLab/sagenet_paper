...
#     bsub -o ../../logs/novosparc/visium_human_heart_loo -q production -M 8000 -R rusage[mem=8000] \
#     -P gpu -gpu - "python3 run_novo.py \
...
#         bsub -o ../../logs/novosparc/visium_human_heart -q production -M 8000 -R rusage[mem=8000] \
#         -P gpu -gpu - "python3 run_novo.py \
#         -i ../../data_tidy --tag visium_human_heart\
#         --tag_ref $tag_ref \
#         --tag_query  $tag_query \
