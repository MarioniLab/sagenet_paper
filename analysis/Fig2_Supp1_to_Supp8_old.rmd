...
# wflow_build(files='analysis/Fig2_Supp1_to_Supp8.rmd', view=F, verbose=T, delete_cache=T)
```
...
fig_list[['2B-D']]  = 
  ...
  plot_spacer()    +
  fig_list[['2D']] + 
  plot_layout(widths=c(9, 1, 9, 1, 8), ncol = 5, guides='collect')
fig_list[['2B-D']]
```
...
```{r Supp3, fig.height=20, fig.width=20, message=FALSE, cache=FALSE}
...
```{r Supp5, fig.height=4, fig.width=5, message=FALSE, cache=FALSE, eval=TRUE}
...
```{r Supp7, fig.height=8, fig.width=8, message=FALSE, cache=FALSE}
meta_dt[, ent :=  (ent_embryo1_2_leiden_1 + ent_embryo1_2_leiden_0.1 + ent_embryo1_2_leiden_0.01 + ent_embryo1_2_leiden_0.5 + ent_embryo1_2_leiden_0.05)/5 ]
